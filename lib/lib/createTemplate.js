...
function setupVariablesName(kataName, options) {
    ...
    var templatePath = exports.KATACLISM_ROOT_DIRECTORY + "templates/" + templateType;
...
function createTemplate(kataName, options, kataDescription) {
    ...
    var kataDescriptionReadMe = exports.KATACLISM_ROOT_DIRECTORY + "src/katasReadme/" + kataName + ".md";
