...
function setupVariablesName(kataName, options) {
    ...
    var templatePath = kataclismDirectory + "/templates/" + templateType;
    var kataPath = kataclismDirectory + "/" + kataName;
...
function createTemplate(kataName, options, kataDescription) {
    ...
    var kataDescriptionReadMe = kataclismDirectory + "/src/katasReadme/" + kataName + ".md";
